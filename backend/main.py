...
app.include_router(knowledge_router, prefix=f"{settings.API_V1_STR}/knowledge", tags=["知识库"])
app.include_router(document_router, prefix=f"{settings.API_V1_STR}/document", tags=["文档处理"])
